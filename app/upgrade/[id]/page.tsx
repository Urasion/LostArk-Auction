...
import UpgradeMaterialsDetailChart from './components/upgradematerials-detail-chart';
import UpgradeMaterialsDetailTable from './components/upgradematerials-detail-table';
